...
// Simulando os dados diretamente no componente (poderia ser vindo via props ou API)
...
function ListagemTodosClientes({tema}:Props){
    useEffect(() => {
        ...
        <div className="row">
            <div className="col s10 offset-s1">
                ...
                <div className="center-align">
                    <a className={`btn-floating btn-large waves-effect waves-light left-align ${tema}`}><i className="material-icons">arrow_back</i></a>
                    <a className={`btn-floating btn-large waves-effect waves-light left-align ${tema}`}><i className="material-icons">arrow_forward</i></a>
                </div>
            </div>
        </div>
    );
